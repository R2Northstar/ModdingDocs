...
On Linux you can also use shell scripts that convert all wav or mp3 audio files in the current directory, including from folders to wav 16-bit 48000 Hz.
